module.exports = {
    ...
    globals: {
        ...
        mockfs: true,
        resolveUitPath: true,
        createGetParameterValuesMock: true
    },
    plugins: ['chai-expect', 'mocha', 'varspacing', '@typescript-eslint'],
    ...
    rules: {
        ...
        'prefer-const': 'error',
        'prefer-reflect': ['error', { exceptions: ['apply', 'call', 'delete'] }],
        ...
        'padding-line-between-statements': [
            ...
            { blankLine: 'any', prev: ['const', 'let'], next: ['if', 'const', 'let'] }
        ],
        'keyword-spacing': [
            'error',
            {
